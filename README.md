...
- **[rathole](https://github.com/rapiz1/rathole)** - Lightweight, high-performance alternative to frp, written in Rust. `Rust` 🟡
...
- **[WireGuard](https://www.wireguard.com/)** - Fast, modern VPN protocol. Use [wireguard-install](https://github.com/angrist/wireguard-install) for one-click setup. `C` 🟡
...
- **[Nezha](https://github.com/naiba/nezha)** - Multi-server monitoring panel popular in the Chinese VPS community. `Go` 🟡
...
- **[Borgmatic](https://github.com/witten/borgmatic)** - YAML-configured wrapper around BorgBackup. Declarative backup with cron integration. `Python` 🟡
...
- **[Lobe Chat](https://github.com/lobehub/lobe-chat)** - Beautiful multi-model AI chat with plugin ecosystem. `TypeScript` 🟢
...
3. Follow the entry format: `**[Name](url)** - Description. \`Language\` 🟢/🟡/🔴`
...
- 🟢 **Beginner** — One command to install and use
- 🟡 **Intermediate** — Requires configuration
- 🔴 **Advanced** — Requires understanding of underlying concepts

### Guidelines

- Tools must be open-source and actively maintained
